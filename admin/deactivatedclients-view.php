<p class="lead" style="font-size: 20px;">
    Puede ver los clientes desactivados del sistema aqui.
</p>
...
<div class="container">
	<div class="row">
		<div class="col-xs-12">
            <br><br>
            <!-- BUSCADORES SEPARADOS PARA CLIENTES DESACTIVADOS -->
            ...
            <div class="panel panel-warning">
              <div class="panel-heading text-center"><h4 style="font-size: 28px;">Clientes Desactivados</h4></div>
                  ...
                  <table class="table table-striped table-hover" id="tabla-clientes">
                      ...
                      <tbody>
                        <?php
							...
							$clientes=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM clientes WHERE Estado='inactivo' LIMIT $inicio, $regpagina");
                        ...
                        <tr>
                        	...
                        	<td class="text-center">
                        		<span class="label label-warning" style="font-size: 16px;">Inactivo</span>
                        	</td>
                        	<td class="text-center">
                ...
                <?php if($numeropaginas>=1): ?>
                  ...
                  <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li>
                            <a href="configAdmin.php?view=deactivatedclients&pag=<?php echo $pagina-1; ?>" style="font-size: 17px;">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="configAdmin.php?view=deactivatedclients&pag='.$i.'" style="font-size: 17px;">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="configAdmin.php?view=deactivatedclients&pag='.$i.'" style="font-size: 17px;">'.$i.'</a></li>';
                            }
                        }
                    ?>
