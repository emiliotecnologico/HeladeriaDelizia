<p class="lead" style="font-size: 20px;">
    Puede ver los productos desactivados del sistema aqui.
</p>
...
<div class="container">
	<div class="row">
		<div class="col-xs-12">
            <br><br>
            <!-- BUSCADORES SEPARADOS PARA PRODUCTOS DESACTIVADOS -->
            ...
            <div class="panel panel-warning">
              <div class="panel-heading text-center"><h4 style="font-size: 28px;">Productos Desactivados</h4></div>
                ...
                <?php if($numeropaginas>=1): ?>
                  ...
                  <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li>
                            <a href="configAdmin.php?view=deactivatedproducts&pag=<?php echo $pagina-1; ?>" style="font-size: 17px;">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="configAdmin.php?view=deactivatedproducts&pag='.$i.'" style="font-size: 17px;">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="configAdmin.php?view=deactivatedproducts&pag='.$i.'" style="font-size: 17px;">'.$i.'</a></li>';
                            }
                        }
                    ?>
