<p class="lead" style="font-size: 20px;">
    Puede actualizar la información de los productos aqui.
</p>
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-primary text-center" style="font-size: 28px;">Actualizar Datos del Producto</h3>
                <?php
                	$code=$_GET['code'];
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" value="<?php echo $prod['CodigoProd']; ?>" style="font-size: 17px; padding: 12px;" required maxlength="30" readonly name="prod-codigo">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label" style="font-size: 18px;">Nombre de Producto</label>
                                <input type="text" class="form-control" value="<?php echo $prod['NombreProd']; ?>" style="font-size: 17px; padding: 12px;" required maxlength="100" name="prod-name">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label" style="font-size: 18px;">Precio (Bs.)</label>
                                <input type="text" class="form-control" value="<?php echo $prod['Precio']; ?>" style="font-size: 17px; padding: 12px;" required maxlength="20" pattern="[0-9.]{1,20}" name="prod-price">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label" style="font-size: 18px;">Aumento (%)</label>
                                <input type="text" class="form-control" style="font-size: 17px; padding: 12px;" required maxlength="2" pattern="[0-9]{1,2}" name="prod-aumento" value="<?php echo $prod['Aumento']; ?>">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label" style="font-size: 18px;">Stock Disponible</label>
                                <input type="text" class="form-control" value="<?php echo $prod['Stock']; ?>" style="font-size: 17px; padding: 12px;" required maxlength="20" pattern="[0-9]{1,20}" name="prod-stock">
                              </div>
                            </div>
                            <div class="col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group">
                                ...
                                <select class="form-control" style="font-size: 17px; padding: 12px; height: auto; line-height: 1.5;" name="prod-categoria" required>
                                    <?php
                                        $categoria=ejecutarSQL::consultar("SELECT * FROM categoria WHERE Estado='activa'");
                            ...
                            <div class="col-xs-12">
                                ...
                                <p class="text-center" style="font-size: 16px;">
                                    <strong>Imagen actual:</strong> <?php echo $prod['Imagen']; ?>
                                </p>
                                <?php endif; ?>
                            </div>
                            <div class="col-xs-12">
                ...
                <p class="text-center"><button type="submit" class="btn btn-success btn-raised" style="font-size: 18px; padding: 12px 24px;">Actualizar producto</button></p>
                </form>
            </div>
        </div>
    </div>
